...
struct qt_meta_stringdata_rowAndString_t {
    QByteArrayData data[4];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rowAndString_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rowAndString_t qt_meta_stringdata_rowAndString = {
    {
QT_MOC_LITERAL(0, 0, 12), // "rowAndString"
QT_MOC_LITERAL(1, 13, 15), // "SignalNoChecked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 3) // "str"

    },
    "rowAndString\0SignalNoChecked\0\0str"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_rowAndString[] = {
...
void rowAndString::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        rowAndString *_t = static_cast<rowAndString *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalNoChecked((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject rowAndString::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rowAndString.data,
      qt_meta_data_rowAndString,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *rowAndString::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *rowAndString::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_rowAndString.stringdata0))
        return static_cast<void*>(const_cast< rowAndString*>(this));
    return QObject::qt_metacast(_clname);
}

int rowAndString::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
